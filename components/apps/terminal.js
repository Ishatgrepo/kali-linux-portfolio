        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full">
                    <div className="flex">
                        <div className=" text-blue-500 ">rishabh@kali</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/rishabh")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-rishabh, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-rishabh":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-rishabh");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-rishabh, todoist, trash, settings, sendmsg ]";
                }
                break;
